...
def tensor_map(
    ...
    def _map(
        ...
        out_index = index_to_position(out_index, out_strides)
        out[out_index] = fn(data)
...
def tensor_zip(
    ...
    def _zip(
        ...
        a_index = index_to_position(a_index, a_strides)
        b_index = index_to_position(b_index, b_strides)
        out_index = index_to_position(out_index, out_strides)
